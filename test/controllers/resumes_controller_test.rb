...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { name: @resume.name, resume_file_size: @resume.resume_file_size, resume_name: @resume.resume_name }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { name: @resume.name, resume_file_size: @resume.resume_file_size, resume_name: @resume.resume_name }
    assert_redirected_to resume_path(assigns(:resume))
  end
